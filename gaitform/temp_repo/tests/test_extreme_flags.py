...
def test_extreme_flags():
    ...
    assert len(
        left_params.flags_for_review) == 2, "Expected exactly 2 flags for this extreme input"
    assert left_params.medial_post_deg == 4.0, "Expected medial post to be capped at 4.0"
    assert left_params.met_pad_position_mm == 182.0, "Expected met pad to be 65% of 280mm"
